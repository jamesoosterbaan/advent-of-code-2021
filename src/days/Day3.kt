...
class Day3(private val inputFile: File): AdventSolution(inputFile) {
    override fun part1() {
        val powerLevels = parseInputFile(inputFile)
    ...
    private fun parseInputFile(file: File): List<String> {
     ...
     */
    private fun getOxygenGeneratorRating(powerLevels: List<String>): Int {
     ...
     *  @param powerLevels a [List<String>] of the power levels to sort through
     */
    private fun getCO2ScrubberRating(powerLevels: List<String>): Int {
        var result: List<String> = powerLevels
        var index = 0
     ...
     */
    private fun decodeBinary(binary: String): Int {
